...
// 天降横财
//-----------------------------------------------------
wls.namespace.EFWindfall = wls.WrapNode.extend
({
    getZorder:function () {
    ...
    onCreate: function()
    {
        ...
        this.minScore = wls.Config.getConfig("990000090")
    },
    ...
    play: function(cnt)
    {
        ...
        wls.CallAfter(this, 1+ 24/60, function(){
            ...
            wls.jumpingNumber(self.fnt_coin,1.5,cnt, 0)
            self.emitter.setVisible(true)
            self.emitter.resetSystem()
        });
        
        wls.CallAfter(this, 6, function(){
            self.isUsing = false
